...
Graphics::Graphics(HWND hWnd)
	...
	//GAIN ACCESS TO TEXTURE SUBSOURCE IN SWAP CHAIN (BACK BUFFER)
...
void Graphics::DrawTestTriangle(float angle, float x, float y)
{
	...
	sd.pSysMem = vertices;
	GFX_THROW_INFO_ONLY(pDevice->CreateBuffer(&bd, &sd, &pVertexBuffer));
...
{
	return "Error Graphics Exception";
}
...
{
	return "Graphics Error Exception[ Device Removed ] (DXGI_ERROR_DEVICE_REMOVED)";
}
